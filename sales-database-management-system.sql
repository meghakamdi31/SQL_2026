...
Employee_id varchar(50),
 ...
 Insert into Customers  (Customer_ID, Customer_Name, Gender, City, State, Phone, Email) 
 values
("C101","Ravi Kumar","Male","Nagpur","Maharashtra","9123456780","ravi.kumar@gmail.com"),
("C102","Kavita Sharma","Female","Pune","Maharashtra","9234567891","kavita.sharma@gmail.com"),
("C103","Vikas Singh","Male","Mumbai","Maharashtra","9345678902","vikas.singh@gmail.com"),
("C104","Riya Patil","Female","Nashik","Maharashtra","9456789013","riya.patil@gmail.com"),
("C105","Arjun Joshi","Male","Indore","Madhya Pradesh","9567890124","arjun.joshi@gmail.com"),
("C106","Simran Gupta","Female","Chennai","Tamil Nadu","9678901235","simran.gupta@gmail.com"),
("C107","Akash Mehta","Male","Vadodara","Gujrat","9789012346","akash.mehta@gmail.com"),
("C108","Nisha Shah","Female","Kanpur","Uttar Pradesh","9890123457","nisha.shah@gmail.com"),
("C109","Varun Jain","Male","Lucknow","Uttar Pradesh","9901234568","varun.jain@gmail.com"),
("C110","Komal Sharma","Female","Jaipur","Rajasthan","9012345679","komal.sharma@gmail.com");
...
INSERT INTO Employees (employee_id,Employee_Nmae,department,Designation,salary)
VALUES
('E101','Aakash Verma','Sales','Sales Executive',35000),
('E102','Sneha Kulkarni','Sales','Sales Manager',60000),
('E103','Rahul Deshmukh','Sales','Sales Executive',38000),
('E104','Kavya Sharma','Sales','Team Lead',50000),
('E105','Nitin Joshi','Sales','Sales Executive',36000);
