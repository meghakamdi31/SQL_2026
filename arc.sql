...
select * from company2
where city = "pune" between 50000 and 90000;

select *from company2
where  em_name like "a%" and salary>50000;

select * from company2
where em_name like "a%" and  salary between  50000 and 80000;

select * from company2
where city = "mumbai" and "pune" and salary between 50000 and 80000;

select * from company2
where department in("it","hr") and salary>60000;

select * from company2
where em_name  like "p%" or em_name like "a%"  and city in ("mumbai","pune");

select * from company2
where department in ("it","finance","sales") and salary between 60000 and 90000;

select * from company2
where em_name like "%a%" and department in ("it","hr") and experience >3;
...
select count(em_name) from company2;

select min(age) from company2;

select max(age) from company2;

select count(age) from company2;
